                        ...
                        <div class="single-slide">
                            <div class="product-card">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.shop.details')}}/1">Revolutionize Your BOOK With These
                        ...
                        <div class="single-slide">
                            <div class="product-card">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.shop.details')}}/1">Turn Your BOOK Into High
                                            Machine</a></h3>
                                </div>
                                <div class="product-card--body">
                                    <div class="card-image">
                        ...
                        <div class="single-slide">
                            <div class="product-card">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.shop.details')}}/1">3 Ways Create Better BOOK With</a>
                                    </h3>
                                </div>
                                <div class="product-card--body">
                                    <div class="card-image">
                        ...
                        <div class="single-slide">
                            <div class="product-card">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.shop.details')}}/1">What You Can Learn From Bill
                                            Gates</a>
                                    </h3>
                                </div>
                                <div class="product-card--body">
                        ...
                        <div class="single-slide">
                            <div class="product-card">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.shop.details')}}/1">Simple Things You To Save BOOK</a>
                                    </h3>
                                </div>
                                <div class="product-card--body">
                                    <div class="card-image">
