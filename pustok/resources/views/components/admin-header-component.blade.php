 ...
 <!-- <div class="preloader flex-column justify-content-center align-items-center">
     <img class="animation__wobble" src="{{asset('admin/assets/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo"
         height="60" width="60">
 </div> -->
 ...
 <nav class="main-header navbar navbar-expand navbar-dark">
     ...
     <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item d-flex">
             ...
             <a class="btn lang mr-2{{LaravelLocalization::getCurrentLocale()==$localeKey?' active':''}}" href="{{LaravelLocalization::getLocalizedURL($localeKey)}}">{{$localeKey}}</a>
             @endforeach
         </li>
     </ul>
 </nav>
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <a href="{{route('admin.dashboard')}}" class="brand-link">
         ...
         <span class="brand-text font-weight-light">Admin Pustok</span>
     </a>
