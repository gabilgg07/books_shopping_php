        ...
        <ul class="navbar-nav">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
                    ...
                    <div class="dropdown-content-body dropdown-scrollable">
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face18.jpg')}}" width="36"
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face24.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face17.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face19.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face16.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3 position-relative">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face10.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                            ...
                            <li class="media">
                                <div class="mr-3 position-relative">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face3.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face4.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                                    <div class="media-title">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('admin/global_assets\images\demo\users\face25.jpg')}}" width="36"
                                        height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                                    <div class="media-title">
            ...
            <li class="nav-item dropdown dropdown-user">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="{{route('manager.account.index')}}" class="dropdown-item"><i class="icon-user-plus"></i> My
                        profile</a>
                    ...
                    <a href="{{route('manager.logout')}}" class="dropdown-item"><i class="icon-switch2"></i> Logout</a>
                </div>
            </li>
        </ul>
    </div>
