        ...
        <div class="w-100 overflow-auto order-2 order-md-1">
            <div class="card">
                <div class="card-body row">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            @include('admin.layouts.includes.lang_tab',['color'=>$color_classes[rand(0,count($color_classes)-1)],'colors'=>$color_classes,'field_name'=>'text_content','field_value'=>$show_view_model['text_contents']])
