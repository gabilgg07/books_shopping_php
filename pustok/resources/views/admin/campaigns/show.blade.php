        ...
        <div class="w-100 overflow-auto order-2 order-md-1">
            <div class="card">
                <div class="card-body row">
                    ...
                    @include('admin.layouts.includes.mini_text', ['field_name'=>'discount_percent',
                    'upper'=>'',
                    'field_value'=>$model->discount_percent, 'color'=>$color_classes[rand(0,count($color_classes)-1)]])
