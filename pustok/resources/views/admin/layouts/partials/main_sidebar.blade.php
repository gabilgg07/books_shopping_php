        ...
        <div class="sidebar-content">
                ...
                <div class="sidebar-user">
                        <div class="card-body">
                                <div class="media">
                                        <div class="mr-3">
                                                <a href="{{route('manager.account.index')}}"><img src="{{asset($user->image?$user->image:'admin/global_assets\images\demo\users\face0.jpg')}}" width="38" height="38" class="rounded-circle" alt=""></a>
                                        </div>
